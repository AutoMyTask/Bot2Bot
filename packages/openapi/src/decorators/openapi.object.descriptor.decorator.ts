...
export class OpenapiObjectDescriptorDecorator {
  ...
  constructor(protected readonly target: TypesCore.New) {
...
export function OpenapiObjectDescriptor(option: OpenapiObjectDescriptorOption) {
  return (target: Object) => {
    const openapiObjectDescriptor = new OpenapiObjectDescriptorDecorator(
      target as TypesCore.New,
    );
