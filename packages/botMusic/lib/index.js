...
var ping_command_1 = require("./app/ping/ping.command");
var gateway_1 = require("discord-api-types/gateway");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                bot = new bot_1.Bot({
                    intents: [
                        gateway_1.GatewayIntentBits.Guilds,
                        gateway_1.GatewayIntentBits.GuildMessages,
                        gateway_1.GatewayIntentBits.GuildVoiceStates,
                    ],
                    token: process.env.TOKEN_DISCORD
                });
                return [4 /*yield*/, bot.bootstrap([
                        ping_command_1.PingCommand
                    ], [
                        ping_command_1.PingCommand.youtubeButton
                    ])];
            case 1:
                _a.sent();
                return [4 /*yield*/, bot.deployCommands()];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
