...
import {AppCore, IServiceCollection, RouteCore, TypesCore} from "api-core-types";
...
export class App implements AppCore.IApp, RouteCore.IRouteMapBuilder {
    ...
    useAuthentification(): AppCore.IApp {
        ...
        for (let convention of this.conventions) {
            ...
            const {handler, schemes, onTokenValidated} = this.services.get(AuthentificationBuilder)
