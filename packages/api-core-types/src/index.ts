...
export namespace Auth {
    ...
    export type AuthentificationBuilderCallback = (builder: Auth.IAuthentificationBuilder) => void
...
export namespace AppCore {
    ...
    export interface IApp {
        ...
        addEndpoints: (callback: RouteCore.CallbackRouteMapBuilder<RouteCore.IRouteMapBuilder>) => IApp
    ...
    export interface IAppBuilder {
        ...
        build: () => AppCore.IApp,
        addAuthentification: (handler: RequestHandler, schemes: Auth.SecurityType[], callback?: Auth.AuthentificationBuilderCallback) => IAppBuilder
    }

}

export namespace RouteCore {
    export type CallbackRouteMapBuilder<T extends IRouteMapBuilder> = (routeMapBuilder: IRouteMapBuilder) => T
